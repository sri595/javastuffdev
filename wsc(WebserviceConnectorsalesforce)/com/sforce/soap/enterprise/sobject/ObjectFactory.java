...
public class ObjectFactory {
    ...
    private final static QName _OFSClientMetadataLogInformationCOFSClientErrorMessageC_QNAME = new QName("urn:sobject.enterprise.soap.sforce.com", "OFSClient__Error_Message__c");
    ...
    private final static QName _OFSClientMetadataLogInformationCOFSClientNameC_QNAME = new QName("urn:sobject.enterprise.soap.sforce.com", "OFSClient__Name__c");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sobject.enterprise.soap.sforce.com", name = "OFSClient__Error_Message__c", scope = OFSClientMetadataLogInformationC.class)
    public JAXBElement<String> createOFSClientMetadataLogInformationCOFSClientErrorMessageC(String value) {
        return new JAXBElement<String>(_OFSClientMetadataLogInformationCOFSClientErrorMessageC_QNAME, String.class, OFSClientMetadataLogInformationC.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sobject.enterprise.soap.sforce.com", name = "OFSClient__Name__c", scope = OFSClientMetadataLogInformationC.class)
    public JAXBElement<String> createOFSClientMetadataLogInformationCOFSClientNameC(String value) {
        return new JAXBElement<String>(_OFSClientMetadataLogInformationCOFSClientNameC_QNAME, String.class, OFSClientMetadataLogInformationC.class, value);
    }
